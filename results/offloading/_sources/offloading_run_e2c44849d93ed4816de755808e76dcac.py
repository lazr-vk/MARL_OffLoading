...
def run_sequential(args, logger):
    ...
    newcontainerinfos = workload.generateNewContainers(args.env_args["new_containers"], args.env_args["seed"])
    ...
    mac = mac_REGISTRY[args.mac](buffer.scheme, groups, args)  # 创建多智能体，select_action(),forward()为主要函数

    # Give runner the scheme
    runner.setup(scheme=scheme, groups=groups, preprocess=preprocess, mac=mac)  # 保存传递的多智能体控制器

    # Learner
    learner = le_REGISTRY[args.learner](mac, buffer.scheme, logger, args)  # 依据特定算法对智能体参数进行训练更新
